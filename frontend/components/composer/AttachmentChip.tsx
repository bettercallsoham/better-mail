  ...
  return (
    <div className={cn(
      ...
      <div className="flex-1 min-w-0">
        <p className="text-[11.5px] font-medium text-gray-700 dark:text-white/70 truncate leading-tight">
          {attachment.name}
        </p>
        <p className="text-[10px] text-gray-400 dark:text-white/25 leading-tight">
          {attachment.uploading ? "Uploading…" : sizeLabel}
        </p>
      </div>
      <button
        onClick={onRemove}
        className="shrink-0 w-4 h-4 flex items-center justify-center rounded text-gray-400 dark:text-white/25 hover:text-gray-600 dark:hover:text-white/55 hover:bg-black/[0.06] dark:hover:bg-white/[0.08] transition-colors"
      >
        <IconX size={10} />
      </button>
    </div>
